...
public class CrimsonFirescale001 : MonoBehaviour
{
    ...
    {        
        ...
        if(state == State.READY)
        {
            ...
            if (Input.GetMouseButton(0) == true)
            {
                ...
                {
                    GameObject obj = ObjectPoolManager.instance.GetPoolObj(PoolObjType.BULLET);
    ...
    private void UsingSkill(PoolObjType type)
    {
        useSkiil = true;
        ...
        if(magAmmo < skillAmmo )
        {
            ...
            {
                GameObject obj = ObjectPoolManager.instance.GetPoolObj(type);
